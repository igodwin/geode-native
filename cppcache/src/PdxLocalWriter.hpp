...
class PdxLocalWriter : public PdxWriter {
 ...
 public:
  ...
  void writeObject(bool value) { m_dataOutput->writeBoolean(value); }

  void writeObject(char16_t value) {
    m_dataOutput->writeInt(static_cast<uint16_t>(value));
  }

  void writeObject(int8_t value) { m_dataOutput->write(value); }

  void writeObject(int16_t value) { m_dataOutput->writeInt(value); }

  void writeObject(int32_t value) { m_dataOutput->writeInt(value); }

  void writeObject(int64_t value) { m_dataOutput->writeInt(value); }

  void writeObject(float value) { m_dataOutput->writeFloat(value); }

  void writeObject(double value) { m_dataOutput->writeDouble(value); }
  ...
  int32_t getStartPositionOffset() { return m_startPositionOffset; }
