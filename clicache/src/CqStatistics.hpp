  ...
  namespace Geode
  {
    namespace Client
    {
      ...
      internal:
        ...
        /// </returns>
        static CqStatistics^ Create( std::shared_ptr<apache::geode::client::CqStatistics> nativeptr )
        {
      ...
      private:
        ...
        /// </summary>
        /// <param name="nativeptr">The native object pointer</param>
        CqStatistics( std::shared_ptr<apache::geode::client::CqStatistics> nativeptr )
        {
