  ...
  namespace Geode
  {
    namespace Client
    {
      ...
      internal:
        ...
        /// </returns>
        static AttributesMutator<TKey, TValue>^ Create( std::shared_ptr<native::AttributesMutator> nativeptr )
        {
      ...
      private:
        ...
        /// </summary>
        /// <param name="nativeptr">The native object pointer</param>
        AttributesMutator<TKey, TValue>( std::shared_ptr<native::AttributesMutator> nativeptr )
        {
